...
- [ ] T011 [P] [US1] Unit test for [user journey] in tests/unit/test_[name].py
...
- [ ] T019 [P] [US2] Unit test for [user journey] in tests/unit/test_[name].py
...
- [ ] T025 [P] [US3] Unit test for [user journey] in tests/unit/test_[name].py
...
- Tests MUST be written and confirmed to FAIL before implementation (Red phase)
- Test tasks MUST be ordered before their corresponding implementation tasks (Green phase)
...
Task: "Unit test for [user journey] in tests/unit/test_[name].py"

# After tests FAIL (Red), launch all models for User Story 1 together:
...
- **Tests are REQUIRED (testing-tdd preset): verify tests FAIL before implementing**
